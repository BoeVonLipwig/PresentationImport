from csv_parser_file_functions import extractFileIntoList, getRawLineFromFile


def validate_data(specialNodes, normalNodes, modifierNodes, numberOfSpecialNodes, lastDetailsFieldIndex, specialFN, nodesFN,
viewsFN, specialNames):
